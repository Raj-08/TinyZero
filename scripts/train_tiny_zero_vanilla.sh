# Vanilla TinyZero training with fixed response length (no adaptive window)
...
trainer.experiment_name=${EXPERIMENT_NAME}_vanilla \
trainer.total_epochs=15 2>&1 | tee verl_demo_vanilla.log
