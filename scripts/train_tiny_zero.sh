# Configuration requirements for 3 GPUs:
# 1. Batch sizes must be divisible by N_GPUS after split: 72/12 → 24/4 per GPU
# 2. ROLLOUT_TP_SIZE must divide N_GPUS: Valid values are 1 or 3 (not 2!)
